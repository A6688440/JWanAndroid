 ...
 * Describe：
 */
public class ListViewAdapterNa extends BaseAdapter {

    private Context mContext;
    private List<NavigationProjectBean.DataBean> list;

    public ListViewAdapterNa(Context mContext, List<NavigationProjectBean.DataBean> list) {
