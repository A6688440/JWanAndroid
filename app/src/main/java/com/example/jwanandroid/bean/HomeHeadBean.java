...
public class HomeHeadBean {
    ...
    public static class DataBean {
         ...
         * type : 0
         * url : https://mp.weixin.qq.com/s/NOjBZuLlcfMd3FbvfK3S9w
         */
